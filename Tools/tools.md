...
| ------- | -------  |------- |
|音乐控件|A command-line music player|[[Code]](https://github.com/ravachol/kew)|
|爬虫|根据网易云音乐的歌单, 下载flac无损音乐到本地. Download the FLAC music from Internet according to your NeteaseCloudMusic playlist.|[[Code]](https://github.com/atlas-comstock/NeteaseCloudMusicFlac)|
|视频控件|Free open-source non-linear video editor|[[Code]](https://github.com/olive-editor/olive)|
|安卓控件|在PC上控制Android设备|[[Code]](https://github.com/pdone/FreeControl)|
|技术学习|Database migrations. CLI and Golang library.|[[Code]](https://github.com/golang-migrate/migrate)|
|翻译|为 CSAPP 视频课程提供字幕，翻译 PPT，Lab。|[[Code]](https://github.com/EugeneLiu/translationCSAPP)|
|数据协同|Univer is a set of enterprise document and data collaboration solutions.|[[Code]](https://github.com/dream-num/univer)|
|聊天应用|Connect AI models (like ChatGPT-3.5/4.0, Baidu Yiyan, New Bing, Bard) to apps (like Wechat, public account, DingTalk, Telegram, QQ). 将 ChatGPT、必应、文心一言、谷歌Bard 等对话模型连接各类应用，如微信、公众号、QQ、Telegram、Gmail|[[Code]](https://github.com/zhayujie/bot-on-anything)|
|聊天应用|Use ChatGPT On Wechat via wechaty|[[Code]](https://github.com/fuergaosi233/wechat-chatgpt)|
|聊天应用|Conversational RPA SDK for Chatbot Makers.|[[Code]](https://github.com/wechaty/wechaty)|
|技术学习|Tensorflow2.0 🍎🍊 is delicious, just eat it! 😋😋|[[Code]](https://github.com/lyhue1991/eat_tensorflow2_in_30_days)|
|技术学习|A library of sklearn compatible categorical variable encoders|[[Code]](https://github.com/scikit-learn-contrib/category_encoders)|
|技术学习|apache spark Apache Spark - A unified analytics engine for large-scale data processing|[[Code]](https://github.com/apache/spark)|
|技术学习|Demonstrate all the questions on LeetCode in the form of animation.（用动画的形式呈现解LeetCode题目的思路）|[[Code]](https://github.com/MisterBooo/LeetCodeAnimation)|
|技术学习|Monitoring and Management Web Application for ElasticSearch instances and clusters.|[[Code]](https://github.com/ElasticHQ/elasticsearch-HQ)|
|技术学习|Fuzzy string matching, grouping, and evaluation.|[[Code]](https://github.com/MaartenGr/PolyFuzz)|
|时间管理|Apache Airflow - A platform to programmatically author, schedule, and monitor workflows|[[Code]](https://github.com/apache/airflow)|
|Latex|Tips for Writing a Research Paper using LaTeX|[[Code]](https://github.com/guanyingc/latex_paper_writing_tips)|
|技术学习|A small web app for watching movies and shows easily|[[Code]](https://github.com/movie-web/movie-web)|
|简历|Resumes generated using the GitHub informations|[[Code]](https://github.com/resume/resume.github.com)|
|技术学习|A list of Free Software network services and web applications which can be hosted on your own servers|[[Code]](https://github.com/awesome-selfhosted/awesome-selfhosted)|
|面试|2023年最新总结，阿里，腾讯，百度，美团，头条等技术面试题目，以及答案，专家出题人分析汇总。|[[Code]](https://github.com/0voice/interview_internal_reference)|
|面试|We will cover some of the most common Deep Learning Interview Questions and answers and provide detailed answers to help you|[[Code]](https://github.com/315386775/DeepLearing-Interview-Awesome-2024)|
|面试|deep learning/ machine learning|[[Code]](https://github.com/vivienzou1/DL-Notes-for-Interview)|
|戈戈圈爱好者|这里是GitHub的草场，也是戈戈圈爱好者的交流地，主要讨论动漫、游戏、科技、人文、生活等所有话题，欢迎各位小伙伴们在此讨论趣事。This is GitHub grassland, and the community place for Gege circle lovers, mainly discusses anime, games, technology, lifing and othe…|[[Code]](https://github.com/gege-circle/home)|
|爬虫|从YouTube上爬取视频|[[Code]](https://github.com/ShaoQiBNU/YouTube_get_video)|
|面试|该仓库主要记录 NLP 算法工程师相关的面试题|[[Code]](https://github.com/songyingxin/NLPer-Interview)|
|技术学习|Jeepay是一套适合互联网企业使用的开源支付系统，支持多渠道服务商和普通商户模式。已对接微信支付，支付宝，云闪付官方接口，支持聚合码支付。|[[Code]](https://github.com/jeequan/jeepay)|
|技术学习|A data generate demo|[[Code]](https://github.com/QinHsiu/DataGenerate)|
|爬虫|⚡ A distributed crawler for weibo, building with celery and requests.|[[Code]](https://github.com/SpiderClub/weibospider)|
|聊天应用|Convert Github Copilot to ChatGPT|[[Code]](https://github.com/aaamoon/copilot-gpt4-service)|
|聊天应用|A cross-platform ChatGPT/Gemini UI (Web / PWA / Linux / Win / MacOS). 一键拥有你自己的跨平台 ChatGPT/Gemini 应用。|[[Code]](https://github.com/ChatGPTNextWeb/ChatGPT-Next-Web)|
|绘图|Official Matplotlib cheat sheets|[[Code]](https://github.com/matplotlib/cheatsheets)|
|Latex|LaTeXML: a TeX and LaTeX to XML/HTML/ePub/MathML translator.|[[Code]](https://github.com/brucemiller/LaTeXML)|
|面试|公众号「宫水三叶的刷题日记」刷穿 LeetCode 系列文章源码|[[Code]](https://github.com/SharingSource/LogicStack-LeetCode)|
|CCF推荐会议|CCF推荐期刊/会议的历年论文数据库。|[[Code]](https://github.com/tmylla/CCF-Rec-Paper-DB)|
|技术学习|🍰 Everything is RSSible|[[Code]](https://github.com/DIYgod/RSSHub)|
...
|数据|Data-Copilot: Bridging Billions of Data and Humans with Autonomous Workflow|[[Code]](https://github.com/zwq2018/Data-Copilot)|
